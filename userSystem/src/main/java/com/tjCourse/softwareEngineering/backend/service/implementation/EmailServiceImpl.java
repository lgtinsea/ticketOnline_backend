...
import com.tjCourse.softwareEngineering.backend.utils.ImageBase64Util;
...
public class EmailServiceImpl implements EmailService {
    ...
    private void sendMail(String to, String subject, String content) {
        ...
        try {
            ...
            messageHelper.setFrom(new InternetAddress(sender, "ticketOnline", "UTF-8"));
    ...
    public void sendReisterEmail(String to,String verifyCode){
        String subject="欢迎注册ticketOnline";
        //String content=createImageContent();
        String content="<p>【ticketOnline】您的邮箱验证码为：" + verifyCode + "</p>" +
                "<p>注册ticketOnline，遍览同济活动</p>";
...
//        String content=createImageContent();
         String content = "<p>【ticketOnline】您的邮箱验证码为：" + verifyCode + "</p>" +
                "<p>您的 ticketOnline 账号正在重置密码，若非本人操作请及时登录处理。</p>";
        sendMail(to,subject,content);
    }
